...
~/Code/pkm-system/                   # Application code
├── pkm_mcp_server/                  # MCP server
├── pkm_ingestion/                   # Ingestion pipeline
├── pkm_obsidian/                    # Obsidian sync
...
```python
# pkm_mcp_server/database/models.py
...
```
1. User drops "AI_Research_Paper.pdf" into ~/PKM/Inbox/
...
5. Obsidian Sync:
   a. Note created: ~/PKM/Obsidian_Vault/Notes/AI_Research_Paper.md
   b. Topic indexes updated: AI.md, AI_LLMs.md, Research_Papers.md
   c. Related document links added

6. File moved to ~/PKM/Library/Research/AI/AI_Research_Paper.pdf
...
- [Metadata Schema Design](./PKM_Design_Metadata_Schema.md)
- [MCP Server Architecture](./PKM_Design_MCP_Server.md)
- [Personal Context Layer](./PKM_Design_Personal_Context.md)
- [Project Memory](./PKM_Project_Memory.docx)
