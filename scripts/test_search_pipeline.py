#!/usr/bin/env python3
"""
Quick test script to verify the PKM search pipeline works end-to-end.
...
TEST_DOCS = [
    {
        ...
        "source_path": "/Users/test/pkm_overview.md"
    },
    {
        "id": "doc2",
        "title": "Hardware Optimization",
        "text": "The PKM system is optimized for Apple Silicon M4 Max. It uses Metal acceleration for embeddings and monitors memory pressure to throttle operations when needed. The 75% memory threshold helps prevent system slowdowns.",
        "source_path": "/Users/test/hardware.md"
    },
    {
        "id": "doc3", 
        "title": "MCP Integration",
        "text": "Connect to Claude Desktop using the Model Context Protocol. MCP exposes PKM tools like search_knowledge, list_recent_files, and get_system_status. This enables AI assistants to access your knowledge base.",
